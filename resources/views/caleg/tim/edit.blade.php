    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="/tim">Tim</a></li>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="row container">
                            <div class="col-12">
                                <a href="/tim" class="btn btn-block btn-primary"><span
                        ...
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="/tim/{{ $tim->id }}" class="form-valide-with-icon needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="nama" value="{{ old('nama', $tim->nama), $tim->nama }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"> <i class="bi bi-card-heading"></i> </span>
                                            <input name="keterangan" value="{{ old('keterangan', $tim->keterangan) }}"
                                                type="text"
                                    ...
                                    <a href="/tim" class="btn btn-light">Batal</a>
                                </form>
                            </div>
