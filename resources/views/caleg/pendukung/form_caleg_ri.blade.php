                                ...
                                <form action="/pendukungcaleg/" class="form-valide-with-icon needs-validation"
                                    ...
                                    <div id="smartwizard" class="form-wizard order-create">
                                        <ul class="nav nav-wizard">
                                            ...
                                            @php
                                                // }
                                                if ($user_update_prov == '' or $id_user == $user_update_prov) {
                                            ...
                                            @endphp
                                            @php
                                                if ($user_update_kabkota == '' or $id_user == $user_update_kabkota) {
                                                    echo '  <li><a class="nav-link" href="#form_b">
                                                    <span>KAB</span>
                                                </a></li>';
                                                }
                                                
                                                // dd($user_update_kabkota);
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="mb-12">
                                                                ...
                                                                <p>Jika Iya Silakan Pilih Calon DPRD Provinsi Nasdem
                                                                </p>
                                                            </div>

                                                            <select name="caleg_prov" class="dropdown-groups">
                                                                <option
                                                                    value="TIDAK MEMILIH CALEG DPR PROVINSI DARI NASDEM">
                                                                    TIDAK MEMILIH CALEG PROVINSI SULUT</option>
                                                                @php
                                                                    $dapil_prov_list = App\Models\DapilProv::get();
                                                                @endphp
                                                                @foreach ($dapil_prov_list as $item_dapil)
                                                                    <optgroup label="{{ $item_dapil->nama }}">
                                                                        @php
                                                                            $caleg_prov = App\Models\CalegProv::where('dapil_prov', $item_dapil->id)->get();
                                                                        @endphp
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <select name="caleg_kabkota" class="dropdown-groups">
                                                                <option
                                                                    ...
                                                                    TIDAK MEMILIH CALEG KABUPTEN KOTA SULUT</option>
                                                                @php
                                                                    $dapil_kabkota_list = App\Models\DapilKabkota::get();
                                                                @endphp
