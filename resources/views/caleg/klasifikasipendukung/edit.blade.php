                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="/klasifikasipendukung/{{ $klasifikasi_pendukung->id }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="nama"
                                                value="{{ old('nama', $klasifikasi_pendukung->nama), $klasifikasi_pendukung->nama }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="keterangan"
                                                value="{{ old('keterangan', $klasifikasi_pendukung->keterangan) }}"
                                                type="text"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label class="text-label form-label" for="validationCustomUsername">Apakah
                                            akan menonaktifkan klasifikasi pendukung ini ?</label>
                                        <div class="form-check form-switch">
                                            <input name="is_active" value="1" class="form-check-input" type="checkbox"
                                                id="flexSwitchCheckChecked"
                                                @if (old('is_active', $klasifikasi_pendukung->is_active)) checked @endif>
                                            <label class="form-check-label" for="flexSwitchCheckChecked">centang jika
                                                ingin mengnonaktifkan klasifikasi pendukung ini</label>
                                        </div>
                                    </div>
